...
var functionMap = {
    ...
    "pg_delete": [
        "mixed pg_delete(resource db, string table, array current[, int options])",
        "Delete records has current (id=>value)"
    ],
    "pg_end_copy": [
    ...
    "pg_select": [
        "mixed pg_select(resource db, string table, array current[, int options])",
        "Select records that has current (id=>value)"
    ],
    "pg_send_execute": [
    ...
    "pg_update": [
        "mixed pg_update(resource db, string table, array fields, array current[, int options])",
        "Update table using values (field=>value) and current (id=>value)"
    ],
    "pg_version": [
