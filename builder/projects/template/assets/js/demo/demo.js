...
var Demo = function() {
  ...
  var runDemoTopbar = function() {
    ...
    if ($(".topbar-multiple-breadcrumbs").length) {
      $('.topbar-multiple-breadcrumbs').multiselect({
        buttonClass: 'btn btn-info btn-md ph30 dropdown-variant-1',
        dropRight: true
      });
    }
  }
  ...
  var runDemoSourceCode = function() {
    ...
    if (bsElement.length && !window.xMode) {
